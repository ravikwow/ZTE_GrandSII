...
.method installApk(Lcom/android/server/BackupManagerService$FileMetadata;Ljava/lang/String;Ljava/io/InputStream;)Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/BackupManagerServiceInjector;->isForceAllowBackup(I)Z
...
.method restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    iget-object v4, v0, Lcom/android/server/BackupManagerService$PerformFullRestoreTask;->mInputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v4}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v4

    invoke-static {v6, v7, v4}, Lcom/android/server/BackupManagerServiceInjector;->addRestoredSize(JI)V
    ...
    iget-object v6, v0, Lcom/android/server/BackupManagerService$PerformFullRestoreTask;->mInputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v6}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v6

    invoke-static {v4, v5, v6}, Lcom/android/server/BackupManagerServiceInjector;->getApplicationInfo(Landroid/content/Context;Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {v4, v6}, Lcom/android/server/BackupManagerServiceInjector;->linkToDeath(Landroid/app/IBackupAgent;I)V
    ...
    invoke-static {v4, v15}, Lcom/android/server/BackupManagerServiceInjector;->needUpdateToken(Landroid/app/IBackupAgent;I)Z
    ...
    invoke-static {v4}, Lcom/android/server/BackupManagerServiceInjector;->onApkInstalled(I)V
...
.method public run()V
    ...
    invoke-static/range {v20 .. v21}, Lcom/android/server/BackupManagerServiceInjector;->readMiuiBackupHeader(Landroid/os/ParcelFileDescriptor;I)V
    ...
    invoke-static/range {v20 .. v21}, Lcom/android/server/BackupManagerServiceInjector;->errorOccur(II)V
    :try_end_6
    ...
    invoke-static/range {v20 .. v23}, Lcom/android/server/BackupManagerServiceInjector;->restoreFileEnd(Lcom/android/server/BackupManagerService;Landroid/app/IBackupAgent;Landroid/app/backup/IBackupManager;I)V
    :try_end_13
...
.method tearDownAgent(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-static {v1}, Lcom/android/server/BackupManagerServiceInjector;->unlinkToDeath(Landroid/app/IBackupAgent;)V
    ...
    iget-object v2, p0, Lcom/android/server/BackupManagerService$PerformFullRestoreTask;->mInputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v2}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v2

    invoke-static {v1, v2}, Lcom/android/server/BackupManagerServiceInjector;->isNeedBeKilled(Ljava/lang/String;I)Z
