...
.method public static startUsageStats(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, v0, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;->startTime:J
...
.method private static writeFile(Ljava/io/File;)V
    ...
    invoke-direct {v13, v0, v14}, Ljava/io/FileWriter;-><init>(Ljava/io/File;Z)V
    :try_end_0
    ...
    sget-object v14, Lcom/android/server/am/MiuiUsageStats;->mUsageStatsMap:Landroid/util/ArrayMap;

    invoke-direct {v11, v14}, Landroid/util/ArrayMap;-><init>(Landroid/util/ArrayMap;)V

    .line 135
    .local v11, "usageStatsMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;>;"
    sget-object v15, Lcom/android/server/am/MiuiUsageStats;->mStats:Landroid/util/ArrayMap;
    ...
    .line 138
    :try_start_3
    sget-object v15, Lcom/android/server/am/MiuiUsageStats;->mFileLock:Ljava/lang/Object;
    ...
    .line 142
    .local v5, "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;"
    if-nez v5, :cond_2

    .line 143
    const-string v14, "MiuiUsageStats"

    new-instance v16, Ljava/lang/StringBuilder;

    invoke-direct/range {v16 .. v16}, Ljava/lang/StringBuilder;-><init>()V

    const-string v17, "writeFile "
    ...
    .end local v5    # "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;"
    ...
    .line 160
    .end local v11    # "usageStatsMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;>;"
    :catch_0
    move-exception v2
    ...
    .line 137
    .end local v12    # "writer":Ljava/io/FileWriter;
    .restart local v11    # "usageStatsMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;>;"
    ...
    .restart local v5    # "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;>;"
    ...
    check-cast v4, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;

    .line 149
    .local v4, "item":Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;
    ...
    iget-object v0, v4, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;->action:Ljava/lang/String;
    ...
    iget-object v0, v4, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;->name:Ljava/lang/String;
    ...
    iget-wide v0, v4, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;->startTime:J
    ...
    iget-wide v0, v4, Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;->endTime:J
    ...
    invoke-virtual {v13, v14}, Ljava/io/FileWriter;->write(I)V
    ...
    .line 157
    .end local v4    # "item":Lcom/android/server/am/MiuiUsageStats$UsageStatsItem;
