...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    .line 212
    iput-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mSmartShowContext:Landroid/content/ISmartShowContext;

    .line 213
    iput-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mDmSmartShowFuncs:Lcom/android/server/display/IDmSmartShowFuncs;
    ...
    iput-object v0, p0, Lcom/android/server/display/DisplayManagerService;->mSmartShowContext:Landroid/content/ISmartShowContext;

    .line 222
    iget-object v0, p0, Lcom/android/server/display/DisplayManagerService;->mSmartShowContext:Landroid/content/ISmartShowContext;

    const-string v1, "DMS"

    invoke-interface {v0, v1}, Landroid/content/ISmartShowContext;->getSmartShowFuncs(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/server/display/IDmSmartShowFuncs;

    iput-object v0, p0, Lcom/android/server/display/DisplayManagerService;->mDmSmartShowFuncs:Lcom/android/server/display/IDmSmartShowFuncs;
...
.method private addLogicalDisplayLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    sget-boolean v6, Landroid/util/PowerMoConfig;->WITHOUT_REMOTE_DISPLAY:Z

    if-nez v6, :cond_3

    .line 1032
    iget-object v6, p0, Lcom/android/server/display/DisplayManagerService;->mDmSmartShowFuncs:Lcom/android/server/display/IDmSmartShowFuncs;

    invoke-virtual {v1, v6}, Lcom/android/server/display/LogicalDisplay;->setSmartShowFuncs(Lcom/android/server/display/IDmSmartShowFuncs;)V
...
.method private configureDisplayInTransactionLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    .line 1149
    .local v4, "srcDisplayId":I
    sget-boolean v7, Landroid/util/PowerMoConfig;->WITHOUT_REMOTE_DISPLAY:Z
    ...
    .line 1150
    iget-object v7, p0, Lcom/android/server/display/DisplayManagerService;->mDmSmartShowFuncs:Lcom/android/server/display/IDmSmartShowFuncs;

    invoke-virtual {v0}, Lcom/android/server/display/LogicalDisplay;->getDisplayIdLocked()I

    move-result v8

    invoke-interface {v7, v8}, Lcom/android/server/display/IDmSmartShowFuncs;->getMapDisplay(I)I
    ...
    .restart local v4    # "srcDisplayId":I
    :cond_4
    if-nez v3, :cond_1
    ...
    .line 1181
    iget-object v5, p0, Lcom/android/server/display/DisplayManagerService;->mDefaultViewport:Lcom/android/server/display/DisplayViewport;

    iget-boolean v5, v5, Lcom/android/server/display/DisplayViewport;->valid:Z
    ...
    iget v5, v1, Lcom/android/server/display/DisplayDeviceInfo;->touch:I
...
.method public static sendEnableControlCommand(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .param p1, "workTag"    # Ljava/lang/String;
...
# virtual methods
.method public addDisplayMap(IIZ)V
    .locals 6
    .param p1, "srcDisplayId"    # I
    .param p2, "dstDisplayId"    # I
    .param p3, "enable"    # Z
    ...
    .line 857
    .local v1, "srcDisplay":Lcom/android/server/display/LogicalDisplay;
    iget-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mLogicalDisplays:Landroid/util/SparseArray;
    ...
    .line 858
    .local v0, "dstDisplay":Lcom/android/server/display/LogicalDisplay;
    if-eqz v1, :cond_1
    ...
    .line 859
    :cond_2
    iget-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mDmSmartShowFuncs:Lcom/android/server/display/IDmSmartShowFuncs;

    invoke-interface {v2, p1, p2, p3}, Lcom/android/server/display/IDmSmartShowFuncs;->map(IIZ)V
    ...
    .end local v0    # "dstDisplay":Lcom/android/server/display/LogicalDisplay;
    .end local v1    # "srcDisplay":Lcom/android/server/display/LogicalDisplay;
    :catchall_0
    move-exception v2
    ...
    .line 862
    .restart local v0    # "dstDisplay":Lcom/android/server/display/LogicalDisplay;
    .restart local v1    # "srcDisplay":Lcom/android/server/display/LogicalDisplay;
    :cond_3
    :try_start_1
    ...
    const-string v5, "addDisplayMap, Invalid displayId! src:"
...
.method public connectWifiDisplay(Ljava/lang/String;)V
    ...
    const-string v3, "com.powermo.connectivity.services.AndroidServiceRootServer.WORK"

    invoke-static {v2, v3}, Lcom/android/server/display/DisplayManagerService;->sendEnableControlCommand(Landroid/content/Context;Ljava/lang/String;)V
...
.method public getDisplayInfo(I)Landroid/view/DisplayInfo;
    ...
    .local v4, "token":J
    :try_start_0
    sget-boolean v6, Landroid/util/PowerMoConfig;->WITHOUT_SMART_CONFIGURATION:Z
    ...
    invoke-interface {v6, v0, p1}, Lcom/android/server/display/IDmSmartShowFuncs;->checkDisplayInfoWithCallingPid(II)Landroid/view/DisplayInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    invoke-virtual {v3, v1}, Landroid/view/DisplayInfo;->hasAccess(I)Z
