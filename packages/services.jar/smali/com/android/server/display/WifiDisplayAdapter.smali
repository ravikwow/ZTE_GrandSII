...
.method private handleUpdateNotification()V
    ...
    .line 460
    iget v13, p0, Lcom/android/server/display/WifiDisplayAdapter;->mActiveDisplayState:I

    .line 461
    .local v13, "state":I
    iget-object v10, p0, Lcom/android/server/display/WifiDisplayAdapter;->mActiveDisplay:Landroid/hardware/display/WifiDisplay;

    .line 462
    .local v10, "display":Landroid/hardware/display/WifiDisplay;
    monitor-exit v3
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v1, v3, v4, v6}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    ...
    const-string v3, "com.zte.aliveshow"
    ...
    .line 496
    .local v9, "disconnectIntent":Landroid/content/Intent;
    const/4 v1, 0x0
    ...
    invoke-static {v0, v1, v9, v3, v4}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    .line 501
    .end local v9    # "disconnectIntent":Landroid/content/Intent;
    :cond_4
    ...
    invoke-virtual {v10}, Landroid/hardware/display/WifiDisplay;->getFriendlyDisplayName()Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/server/display/WifiDisplayAdapter;->mDisconnectPendingIntent:Landroid/app/PendingIntent;

    invoke-virtual {v1, v3, v4, v6}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v1, v3, v4, v11, v6}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V

    goto/16 :goto_0

    .line 462
    .end local v0    # "context":Landroid/content/Context;
    .end local v10    # "display":Landroid/hardware/display/WifiDisplay;
    ...
    .restart local v10    # "display":Landroid/hardware/display/WifiDisplay;
