...
.method private backupOnePackage(Landroid/content/pm/PackageInfo;Ljava/io/OutputStream;)V
    ...
    .line 2998
    iget-object v1, p0, Lcom/android/server/BackupManagerService$PerformFullBackupTask;->mOutputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v1}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v1

    invoke-static {v3, v1}, Lcom/android/server/BackupManagerServiceInjector;->linkToDeath(Landroid/app/IBackupAgent;I)V
    ...
    invoke-static {v1, v2, p2, v4}, Lcom/android/server/BackupManagerServiceInjector;->routeSocketDataToOutput(Lcom/android/server/BackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/io/OutputStream;I)V
    :try_end_1
    ...
    :goto_3
    :try_start_2
    invoke-static {v3, v5}, Lcom/android/server/BackupManagerServiceInjector;->needUpdateToken(Landroid/app/IBackupAgent;I)Z
    ...
    :cond_2
    :goto_5
    invoke-static {v3}, Lcom/android/server/BackupManagerServiceInjector;->unlinkToDeath(Landroid/app/IBackupAgent;)V
...
.method private tearDown(Landroid/content/pm/PackageInfo;)V
    ...
    iget-object v3, p0, Lcom/android/server/BackupManagerService$PerformFullBackupTask;->mOutputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v3}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v3

    invoke-static {v2, v3}, Lcom/android/server/BackupManagerServiceInjector;->isNeedBeKilled(Ljava/lang/String;I)Z
...
.method private writeAppManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Z)V
    ...
    .line 3136
    invoke-static {p2}, Lcom/android/server/BackupManagerServiceInjector;->resetManifestFileModifiedTime(Ljava/io/File;)V
...
.method public run()V
    ...
    invoke-static/range {v23 .. v23}, Lcom/android/server/BackupManagerService;->access$900(Lcom/android/server/BackupManagerService;)Landroid/content/Context;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/BackupManagerServiceInjector;->getPackageInfo(Landroid/content/Context;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static/range {v23 .. v23}, Lcom/android/server/BackupManagerServiceInjector;->isForceAllowBackup(I)Z
    ...
    invoke-static/range {v23 .. v24}, Lcom/android/server/BackupManagerServiceInjector;->errorOccur(II)V
    ...
    invoke-static/range {v23 .. v24}, Lcom/android/server/BackupManagerServiceInjector;->writeMiuiBackupHeader(Landroid/os/ParcelFileDescriptor;I)V
